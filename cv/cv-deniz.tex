...
$\cdot$ \href{mailto:deniz.ozyildiz@uni-konstanz.de}{deniz.ozyildiz@uni-konstanz.de}\\ % Your email address
\textsc{url}: \href{deniz.fr}{deniz.fr} % Your academic/personal website
...
\section*{Employment}
\years{2024--} \textbf{Substitute professor (Vertretungsprofessor)} \\
Universit\"at Stuttgart \\[.25em]
% (partial substitution for Judith Tonhauser) \\[.25em]
...
\section*{Advising}
\subsubsection*{At Uni Stuttgart}
\years{SoSe 2025} Raheleh Soltani \\
MA thesis topic: Resumptive pronouns in Farsi \\[.25em]
Lea Schmidt (Uni Hohenheim) \\
MA thesis topic: Digital media in English Language Teaching \\[.25em]
Doruk I\c{s}\i{}ldak \\
BA thesis topic: A nanosyntactic approach to Turkish derivational morphology 
\subsubsection*{At Uni Konstanz}
\years{WiSe 2024} Katharina Mattes \\
MA thesis: ``Staying north or going south? A diachronic perspective on the
emerging FOOT-STRUT-split in the West Midlands'' \\
First advisor: Massimiliano Canzi \\[.25em]
\years{SoSe 2023} Leah Doroski \\
MA thesis: ``Neg-raising: Intensity of the attitude'' \\
...
(Journal of Linguistics Research), Proceedings of Tu$+$10 \\
